    ...
    const posts = [
        {
            ...
            img: "https://i.imgur.com/wPPQQJ7.png",
        ...
        },
        {
            ...
            img: "https://i.imgur.com/cUaseCl.png",
        ...
        },
        {
            ...
            img: "https://i.imgur.com/dWEIi2T.png",
        ...
        },
        {
            ...
            img: "https://i.imgur.com/OxrtZhV.png",
    ...
    return (
        <>
            ...
            <div className="grid gap-2 lg:grid-cols-4 shadow-md text-center m-4 text-white">
                {posts.map((items, key) => (
                    <div className="w-full rounded-xl shadow-xl lg:max-w-sm p-7 text-white bg-[#e46904c5]" key={key}>
                        <img
