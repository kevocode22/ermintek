    ...
    <div className="containerSteps mx-auto p-4 lg:p-5 " >
      <div className="grid gap-8 sm:grid-col-2 lg:grid-cols-4 md:grid-cols-2  h-min">
        <div className="cardHome overflow-hidden rounded-2xl p-4 lg:p-3 shadow-lg shadow-orange-500 animate__animated.animate__bounce" style={{backgroundImage:`url(${backGround})`, backgroundSize:"cover", backgroundRepeat:"no-repeat"}} >
          <div className="flex items-center text-[#b331ae]">
          ...
          <h2 className="mt-4 text-xl font-semibold text-white">Encontrá el producto que buscás en el catálogo. Encontrarás sus características y especificaciones.</h2>
        ...
        <div className="overflow-hidden rounded-2xl p-4 lg:p-3 shadow-lg shadow-orange-500" style={{backgroundImage:`url(${backGround})`, backgroundSize:"cover", backgroundRepeat:"no-repeat"}}>
          ...
          <h2 className="mt-4 text-xl font-semibold text-white">Podés elegir el medio de pago que prefieras: Efectivo, transferencia y criptomonedas!</h2>
        ...
        <div className="overflow-hidden rounded-2xl p-4 lg:p-3 shadow-lg shadow-orange-500" style={{backgroundImage:`url(${backGround})`, backgroundSize:"cover", backgroundRepeat:"no-repeat"}}>
          ...
          <h2 className="mt-4 text-xl font-semibold text-white">Contactate con nosotros mediante llamada o Whatsapp para coordinar medios de pago y tiempo de entrega. Se te entregará un comprobante de tu compra.</h2>
        ...
        <div className="overflow-hidden rounded-2xl  p-4 lg:p-3 shadow-lg shadow-orange-500" style={{backgroundImage:`url(${backGround})`, backgroundSize:"cover", backgroundRepeat:"no-repeat"}}>
          ...
          <h2 className="mt-4 text-xl font-semibold text-white">Esperá en la comodidad de tu casa. Hacemos envíos a todo el país. Dentro de CABA, los envíos son gratuitos. </h2>
